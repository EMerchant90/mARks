...
class ARAnnotation: UIView {
    ...
    var logoImage: [UIImage] = [
        UIImage(named: "notpaid")!,
        UIImage(named: "freeparking")!
    ]
...
//    func logoImages(inputArray:Array<UIImage>) -> UIImage {
//        var thisImage = logoImage
//        
//        return thisImage
//    }
    
//    func logoImage(UIImage: String) -> UIImage {
//        return image
//    }
    
    //func getTooltipImage() -> UIImage { return  }
//
