...
class ContainerViewController: UIViewController {
    ...
    //Motion Tracking allows to get header for debugging (ios 11+)
    ...
    // Corrects the heading for when device is in landscape
    ...
    func startSpinnerInView(view: UIView) -> UIView {
        ...
        UIView.animate(withDuration: 0.3, animations: {loadingContainer.transform = CGAffineTransform(scaleX: 1, y: 1)
    ...
    func locationManager(_ manager: CLLocationManager, didChangeAuthorization status: CLAuthorizationStatus) {
        ...
        case .denied,
            ...
            let noLocationAlert = UIAlertController(
                title: "Location Access Disables",
                message: "In order to see items around you, please open settings on your phone and grant location access.",
